...
class BelongsTo extends Relation {
	...
	public function addConstraints()
	{
		if (static::$constraints)
		{
			...
			$this->query->where($table.'.'.$this->otherKey, '=', $this->parent->getAttributeValue($this->foreignKey));
		}
	}
	...
	protected function getEagerModelKeys(array $models)
	{
		...
		{
			if ( ! is_null($value = $model->getAttributeValue($this->foreignKey)))
			{
				$keys[] = $value;
			}
		}
	...
	public function match(array $models, Collection $results, $relation)
	{
		...
		foreach ($models as $model)
		{
			if (isset($dictionary[$model->getAttributeValue($foreign)]))
			{
				$model->setRelation($relation, $dictionary[$model->getAttributeValue($foreign)]);
			}
		}
